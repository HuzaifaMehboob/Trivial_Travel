...
const Nav = ({openNav}:Props) => {
  ...
  return (
    <div className={` ${navBg?'shadow-md bg-blue-950 text-white':'fixed'} transition-all duration-200 h-[12vh] z-[1000]  fixed w-full`}>
        <div className='flex items-center h-full justify-between w-[90%] xl:w-[90%] mx-auto'>
            ...
            <div className='flex items-center space-x-2'>
                ...
                <h1 className='text-xl md:text-2xl text-white uppercase font-bold'>Trivial</h1>
            </div>
            {/* NAVBAR LINKS */}
